...
class Quanzi extends Component{
    ...
    componentDidMount() {
        ...
        try{
            ...
            this.props.dispatch(getQuanziAction(this.state.currentPage,(totalPage)=>{this._loadComplete(totalPage)}));
        }
    }
    //下拉刷新
    _refresh = ()=>{
        ...
        this.props.dispatch(getQuanziAction(1,(totalPage)=>{this._loadComplete(totalPage)}));
    };
    //判断是否滚动到底部
...
export default connect(select)(Quanzi);
